...
public class Silly implements Comparable<Silly>{
     ...
     * Creates a new Silly object in an alternative way.
     * This constructor takes in two strings as an argument.
     *
     * @param first_str a string for this Silly instance's name.
     * @param second_str a second string for this Silly instance's name.
     */
